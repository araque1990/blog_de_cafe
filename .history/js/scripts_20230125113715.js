...
formulario.addEventListener('submit', function(e) {
  ...
  const { mensaje } =  datos;
  if(nombre === '' || email === '') { // La validacion principal la hemos hecho en el HTML con el required, este es solo un ejemplo para ver como se hace con JS
    mostrarError('El nombre o email estan vacios')
    return
  }
